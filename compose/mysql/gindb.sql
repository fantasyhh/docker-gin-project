...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`gindb` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
CREATE TABLE `productlines` (
  ...
  `htmlDescription` varchar(6000) DEFAULT NULL,
...
-- Records of customers
-- ----------------------------
INSERT INTO `auth` (`username`,`password`,`email`) VALUES ('admin','admin','admin@163.com');
INSERT INTO `auth` (`username`,`password`,`email`) VALUES ('guest','guest','guest@gmail.com');
